...
class DataTable extends StatelessWidget {
  ...
  final BoxDecoration headerRowDecoration;
  ...
  Widget build(BuildContext context) {
    ...
    final BoxDecoration _kSelectedDecoration =rowDecoration?? BoxDecoration(
    ...
    final BoxDecoration _kUnselectedDecoration =headerRowDecoration?? BoxDecoration(
      border: Border(bottom: Divider.createBorderSide(context, width: dividerThickness)),
    );
