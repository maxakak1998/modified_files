...
class CalendarController {
  ...
  DateTime get preSelectedDay => _preSelectedDay;
  ...
  void setSelectedDay(
    ...
    if(_isSameDay(_preSelectedDay, _selectedDay)){
      _preSelectedDay = _selectedDay;
    } else {
      _preSelectedDay = normalizedDate;
    }
  ...
  bool isBetweenSelectedArea(DateTime day) {
    DateTime min = selectedDay.millisecondsSinceEpoch > preSelectedDay.millisecondsSinceEpoch ? preSelectedDay : selectedDay;
    DateTime max = selectedDay.millisecondsSinceEpoch < preSelectedDay.millisecondsSinceEpoch ? preSelectedDay : selectedDay;
  ...
  bool check2DatePicked() {
    DateTime min = selectedDay.millisecondsSinceEpoch > preSelectedDay.millisecondsSinceEpoch ? preSelectedDay : selectedDay;
    DateTime max = selectedDay.millisecondsSinceEpoch < preSelectedDay.millisecondsSinceEpoch ? preSelectedDay : selectedDay;

    if(min.millisecondsSinceEpoch == max.millisecondsSinceEpoch){
      return false;
    } else {
      return true;
    }
  ...
  bool compareDayMax(DateTime day) {
    DateTime max = selectedDay.millisecondsSinceEpoch < preSelectedDay.millisecondsSinceEpoch ? preSelectedDay : selectedDay;
    if(day.millisecondsSinceEpoch == max.millisecondsSinceEpoch) {
      return true;
    } else {
      return false;
    }
  ...
  bool isPreSelectedDay(DateTime day) {
    return _isSameDay(day, preSelectedDay);
  }
